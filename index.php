			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info ">FREESHIP</h4>
						</div>
					</div>	
					<h6 class="text">		Miễn phí vận chuyển cho đơn hàng từ 300.000</h6>
				</div>
			</div><!-- .col -->
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info">Mẫu mã đa dạng</h4>
						</div>
					</div>
					<h6 class="text">Hàng Quảng Châu chất lượng cao</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info">Giảm giá lên đến 30%</h4>
						</div>
					</div>
					<h6 class="text">Một số mặt hàng giảm giá đến 30%, tặng kèm các đồ phụ kiện</h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
...
<!-- ============================================== INFO BOXES : END ============================================== -->		
		...
		<div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp">
			<div class="more-info-tab clearfix">
			   <h3 style="font-family: Arial" class="new-product-title pull-left">Sản phẩm nổi bật</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					<li class="active"><a href="#all" data-toggle="tab">Tất cả</a></li>
					<li><a href="#books" data-toggle="tab">Áo</a></li>
					<li><a href="#furniture" data-toggle="tab">Quần</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
...
?>
	...
	<div class="product">		
		...
		<?php if($row['productAvailability']=='Còn hàng'){?>
					<div class="action"><a href="index.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="lnk btn btn-primary">Thêm vào giỏ</a></div>
				<?php } else {?>
				...
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 style="font-family: Arial" class="section-title">Áo khoác</h3>
...
<?php }?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 style="font-family: Arial" class="section-title">Quần</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
...
<?php }?>
	...
	<section class="section featured-product inner-xs wow fadeInUp">
		<h3 style="font-family: Arial" class="section">Xu hướng</h3>
