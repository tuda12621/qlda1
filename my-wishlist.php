...
<div class="body-content outer-top-bd">
	...
	<div class="table-responsive">
		<table class="table">
			<thead>
				<tr>
					<th style="font-family: Roboto" colspan="4">Danh sách yêu thích của tôi</th>
				</tr>
			</thead>
			<tbody>
<?php
...
?>
				...
				<?php } } else{ ?>
				<tr>
					<td style="font-size: 18px; font-weight:bold ">Danh sách yêu thích của bạn đang để trống.</td>
