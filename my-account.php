...
header('location:login.php');
...
else{ //thay đổi thông tin ngoài email
	if(isset($_POST['update']))
	{
		...
		if($query)
		{
echo "<script>alert('Thông tin của bạn đã cập nhật thành công.');</script>";
		}
	}
...
{
	echo "<script>alert('Mật khẩu của bạn không đúng !!');</script>";
}
}
...
{
alert("Mật khẩu mới đang để trống !!");
document.chngpwd.newpass.focus();
return false;
}
else if(document.chngpwd.cnfpass.value=="")
{
alert("Nhập lại mật khẩu mới đang để trống!!");
...
<div class="form-group">
			 ...
			 <input type="password" class="form-control unicase-form-control text-input" id="newpass" name="newpass">
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Confirm Password">Nhập lại mật khẩu mới <span>*</span></label>
