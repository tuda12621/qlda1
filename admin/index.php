...
{
$_SESSION['errmsg']="Sai tên người dùng hoặc mật khẩu";
$extra="index.php";
$host  = $_SERVER['HTTP_HOST'];
$uri  = rtrim(dirname($_SERVER['PHP_SELF']),'/\\');
header("location:http://$host$uri/$extra");
...
<head>
	...
	<title>Tự học tiếng Trung | Admin đăng nhập</title>
...
<body>
	...
	<div class="footer">
		<div class="container">
			...
			<b class="copyright">&copy; 2020 </b> HAT
		</div>
	</div>
