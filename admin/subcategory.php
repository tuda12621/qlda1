...
$_SESSION['msg']="Tạo thành công thể loại !!";
...
<div class="control-group">
<label class="control-label" for="basicinput">Tên thể loại phụ</label>
<div class="controls">
<input type="text" placeholder="Nhập vào đây"  name="subcategory" class="span8 tip" required>
</div>
</div>
