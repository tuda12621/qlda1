...
<div class="controls">
<input type="password" placeholder="Nhập mật khẩu cũ vào đây"  name="password" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="password" placeholder="Nhập mật khẩu mới vào đây"  name="newpassword" class="span8 tip" required>
</div>
</div>
