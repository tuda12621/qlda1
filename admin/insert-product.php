...
<div class="control-group">
<label class="control-label" for="basicinput">Xuất bản</label>
<div class="controls">
<input type="text"    name="productCompany"  placeholder="Nhập tên nhà xuất bản" class="span8 tip" required>
</div>
</div>
<div class="control-group">
<label class="control-label" for="basicinput">Giá sản phẩm trước khi giảm giá</label>
<div class="controls">
<input type="text"    name="productpricebd"  placeholder="Nhập giá" class="span8 tip" required>
</div>
</div>

<div class="control-group">
<label class="control-label" for="basicinput">Giá sản phẩm sau khi khuyến mãi</label>
<div class="controls">
...
<div class="controls">
<textarea  name="productDescription"  placeholder="Nhập miêu tả" rows="6" class="span8 tip">
</textarea>  
</div>
</div>
