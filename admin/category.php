...
date_default_timezone_set('Asia/Kolkata');// c
...
$_SESSION['msg']="Thể loại tạo thành công !!";
...
<div class="controls">
<input type="text" placeholder="Nhập vào đây"  name="category" class="span8 tip" required>
</div>
</div>
