...
echo "<script>alert('Sản phẩm đã thêm vào yêu thích.');</script>";
...
<div class="side-menu animate-dropdown outer-bottom-xs">
    <div class="head"><i class="icon fa fa-align-justify fa-fw"></i>Phân loại phụ</div>        
...
<!-- ================================== TOP NAVIGATION : END ================================== -->	            <div class="sidebar-module-container">
	            	<h3 class="section-title">Tự học tiếng Trung</h3>
			...
			<div class="product-price">	
				...
				<div class="action">
					...
					<?php if($row['productAvailability']=='Còn hàng'){?>
							...
							<button class="btn btn-primary" type="button">Thêm vào giỏ</button></a>
								<?php } else {?>
