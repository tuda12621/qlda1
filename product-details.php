	...
	if(isset($_SESSION['cart'][$id])){
		...
		if(mysqli_num_rows($query_p)!=0){
			...
			$_SESSION['cart'][$row_p['id']]=array("quantity" => 1, "price" => $row_p['productPrice']);
					echo "<script>alert('Sản phẩm đã được thêm vào giỏ của bạn')</script>";
...
echo "<script>alert('Sản phẩm được thêm vào yêu thích');</script>";
...
<div class="sidebar-widget outer-bottom-xs wow fadeInUp">
	<h3 style="font-family: Roboto" class="section-title">Thể loại</h3>
                ...
                <div class="item">
					...
					<div class='col-sm-6 col-md-7 product-info-block'>
						<div class="product-info">
							<h1 style="font-family: Roboto" class="name"><?php echo htmlentities($row['productName']);?></h1>
...
<?php } ?>
							<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span style="font-family: Roboto" class="label">Tình trạng :</span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box">
...
<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span style="font-family: Roboto" class="label">Thương hiệu:</span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box">
...
<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span style="font-family: Roboto" class="label">Vận chuyển:</span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box">
							...
							<div class="quantity-container info-container">
								<div class="row">
									...
									<div class="col-sm-2">
										<span style="font-family: Roboto" class="label">Số lượng :</span>
									</div>
...
<?php if($row['productAvailability']=='Còn hàng'){?>
										<a href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i> Thêm vào giỏ</a>
													<?php } else {?>
							...
							<div class="product-social-link m-t-20 text-right">
								...
								<div class="social-icons">
						            <ul class="list-inline">
						                <li><a class="fa fa-facebook" href="https://www.facebook.com/profile.php?id=100024810891958"></a></li>
					...
					<div class="row">
						<div class="col-sm-3">
							<ul id="product-tabs" class="nav nav-tabs nav-tab-cell">
								<li class="active"><a style="font-family: Roboto" data-toggle="tab" href="#description">Miêu tả</a></li>
								<li><a style="font-family: Roboto" data-toggle="tab" href="#review">REVIEW</a></li>
								...
								<div id="review" class="tab-pane">
									<div class="product-tab">
										...
										<div class="product-reviews">
											<h4 style="font-family: Roboto" class="title">Người dùng nhận xét</h4>
...
?>
											...
											<div class="reviews" style="border: solid 1px #000; padding-left: 2% ">
												<div class="review">
													...
													<div style="font-family: Roboto" class="text"><b>Chất lượng :</b>  <?php echo htmlentities($rvw['quality']);?> Sao</div>
													<div style="font-family: Roboto" class="text"><b>Giá cả :</b>  <?php echo htmlentities($rvw['price']);?> Sao</div>
													<div style="font-family: Roboto" class="text"><b>Đánh giá :</b>  <?php echo htmlentities($rvw['value']);?> Sao</div>
										...
										<div class="product-add-review">
											<h4 style="font-family: Roboto" class="title">Viết bình luận của bạn</h4>
												...
												<div class="form-container">
														...
														<div class="row">
															<div class="col-sm-6">
																...
																<div class="form-group">
																	<label for="exampleInputSummary">Bạn đã mua những sản phẩm gì từ chúng tôi <span class="astk">*</span></label>
...
<section class="section featured-product wow fadeInUp">
	<h3 style="font-family: Roboto" class="section-title">Sản phẩm liên quan </h3>
			...
			<div class="product-price">	
				...
				<div class="action">
					<ul class="list-unstyled">
						...
						<a href="product-details.php?page=product&action=add&id=<?php echo $rw['id']; ?>" class="lnk btn btn-primary">Thêm vào giỏ</a>
