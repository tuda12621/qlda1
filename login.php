...
<html lang="vi">
	<head>
	    ...
	    <title>SURIKID| Đăng nhập | Đăng ký</title>
...
<div class="col-md-6 col-sm-6 sign-in">
	...
	<p class="">Chào mừng bạn đăng nhập vào tài khoản.</p>
...
<div class="col-md-6 col-sm-6 create-new-account">
	...
	<p class="text title-tag-line">Tạo tài khoản SURIKID cho riêng bạn.</p>
...
<div class="form-group">
	...
	<span class="checkout-subtitle outer-top-xs">Đăng ký với chúng tôi ngay hôm nay.  </span>

<!-- tạo tài khonar mới -->			</div><!-- /.row -->
		</div>
