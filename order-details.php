		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th style="font-family: Roboto" class="cart-sub-total item">Giá trên 1 sản phẩm</th>
					<th style="font-family: Roboto" class="cart-total item">Tổng</th>
					<th style="font-family: Roboto" class="cart-total item">Phương thức thanh toán</th>
					<th style="font-family: Roboto" class="cart-description item">Ngày đặt hàng</th>
...
<?php $cnt=$cnt+1;} } else { ?>
				<tr><td colspan="8">Không hợp lệ</td></tr>
				<?php } ?>
			</tbody><!-- /tbody -->
		</table><!-- /table -->
