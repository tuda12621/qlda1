...
echo "<script>alert('sản phẩm đã thêm vào');</script>";
...
<!-- ================================== TOP NAVIGATION : END ================================== -->	            <div class="sidebar-module-container">
	            	<h3 class="section-title">Danh mục thời trang</h3>
...
{?>							
	...
	<div class="product">		
	  ...
	  <?php } } else {?>
		...
		<div class="col-sm-6 col-md-4 wow fadeInUp"> <h3>Không có sản phẩm nào tồn tại</h3>
		</div>
