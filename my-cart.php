...
// code cập nhật địa chỉ thanh toán
	if(isset($_POST['update']))
	{
		...
		if($query)
		{
echo "<script>alert('Địa chỉ  đã được cập nhật');</script>";
		}
	}


// code cập nhật địa chỉ giao hàng
	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class='active'>Giỏ tài liệu</li>
			</ul>
...
if(!empty($_SESSION['cart'])){
	?>
		<table style="font-family: Roboto"class="table table-bordered">
			<thead>
				<tr>
					<th style="font-family: Roboto" class="cart-romove item">Chọn</th>
					<th style="font-family: Roboto" class="cart-description item">Minh họa</th>
					<th style="font-family: Roboto" class="cart-product-name item">Tên sản phẩm</th>
			
					<th style="font-family: Roboto" class="cart-qty item">Số lượng</th>
					<th style="font-family: Roboto" class="cart-sub-total item">Giá 1 sản phẩm</th>
					<th style="font-family: Roboto" class="cart-sub-total item">Phí vận chuyển</th>
					<th style="font-family: Roboto" class="cart-total last-item">Tổng cộng</th>
				</tr>
			</thead><!-- /thead -->
			<tfoot>
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								<a href="index.php" class="btn btn-upper btn-primary outer-left-xs">Tiếp tục đặt </a>
...
<!--	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span style="font-family: Roboto" class="estimate-title">Địa chỉ giao hàng</span>
				</th>
			</tr>
		</thead>
		<tbody>
...
<div style="font-family: Roboto" class="form-group">
...
<div style="font-family: Roboto" class="form-group">
						...
						<div class="form-group">
					    <label class="info-title" for="Billing State ">Trạng thái   <span>*</span></label>
...
<div class="col-md-4 col-sm-12 cart-shopping-total">
		...
		<thead>
			<tr>
				<th>
					...
					<div style="font-family: Roboto" class="cart-grand-total">
						Tổng<span class="inner-left-md"><?php echo $_SESSION['tp']="$totalprice". ""; ?></span>
					</div>
				</th>
			</tr>
		</thead><!-- /thead -->
	...
	<?php } else {
echo "Giỏ của bạn đang trống, hay thêm sản phẩm";
		}?>
</div>			</div>
		</div> 
		</form>
